...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FreeTimes.free_start'
        db.delete_column(u'quick_freetimes', 'free_start')

        # Adding field 'FreeTimes.free_start_dateTime'
        db.add_column(u'quick_freetimes', 'free_start_dateTime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FreeTimes.free_start'
        db.add_column(u'quick_freetimes', 'free_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FreeTimes.free_start_dateTime'
        db.delete_column(u'quick_freetimes', 'free_start_dateTime')
