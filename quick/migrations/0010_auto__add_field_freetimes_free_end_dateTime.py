...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FreeTimes.free_end_dateTime'
        db.add_column(u'quick_freetimes', 'free_end_dateTime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FreeTimes.free_end_dateTime'
        db.delete_column(u'quick_freetimes', 'free_end_dateTime')
