...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FreeTimes.free_time_amount'
        db.alter_column(u'quick_freetimes', 'free_time_amount', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'FreeTimes.free_time_amount'
        db.alter_column(u'quick_freetimes', 'free_time_amount', self.gf('django.db.models.fields.DateTimeField')(null=True))
