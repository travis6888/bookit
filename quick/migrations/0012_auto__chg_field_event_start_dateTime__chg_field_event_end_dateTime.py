...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quick_event', 'start_dateTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.end_dateTime'
        db.alter_column(u'quick_event', 'end_dateTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.start_dateTime'
        db.alter_column(u'quick_event', 'start_dateTime', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.end_dateTime'
        db.alter_column(u'quick_event', 'end_dateTime', self.gf('django.db.models.fields.DateField')(null=True))
