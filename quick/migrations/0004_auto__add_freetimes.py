...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quick_freetimes', (
            ...
            ('free_time_amount', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'quick.freetimes': {
            ...
            'free_time_amount': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
