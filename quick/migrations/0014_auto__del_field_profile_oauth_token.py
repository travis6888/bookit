...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.oauth_token'
        db.delete_column(u'quick_profile', 'oauth_token')


    def backwards(self, orm):
        # Adding field 'Profile.oauth_token'
        db.add_column(u'quick_profile', 'oauth_token',
