...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'quick_event', 'event_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event.picture'
        db.alter_column(u'quick_event', 'picture', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Event.start_time'
        db.alter_column(u'quick_event', 'start_time', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Event.end_time'
        db.alter_column(u'quick_event', 'end_time', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'Event.event_url'
        db.delete_column(u'quick_event', 'event_url')


        # Changing field 'Event.picture'
        db.alter_column(u'quick_event', 'picture', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Event.start_time'
        db.alter_column(u'quick_event', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.end_time'
        db.alter_column(u'quick_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
